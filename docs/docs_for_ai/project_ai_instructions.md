...
Use this template to push AI agents toward the best code quality possible: typed Python, small public APIs, design-first changes, TDD, and full verification before completion.

## Required Workflow

1. Read `docs/docs_for_ai/status.md` before making changes.
2. Bootstrap a fresh template copy before long-term development.
3. Read `docs/api.md` before changing public behavior.
4. Inspect the directly affected files before editing them.
...
- Finish with full verification, not a cheap path.
