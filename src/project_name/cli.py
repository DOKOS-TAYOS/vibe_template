...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Project template CLI for high-rigor AI-assisted Python projects."
    )
    ...
    quality_parser = subparsers.add_parser(
        "quality",
        help="Run the full Ruff, pytest, and pyright verification flow.",
    )
    quality_parser.add_argument(
        "--check-only",
        action="store_true",
        help="Run read-only verification without applying Ruff fixes.",
    )
