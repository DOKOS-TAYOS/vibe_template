...
- Dependabot, CodeQL, dependency review, and Python dependency auditing defaults under `.github`
...
- `.github/workflows/security.yml` runs dependency review on pull requests, CodeQL scanning, and `pip-audit`.
